...
function ProductCard({
  ...
  return (
    <div className=" rounded-[16px]  overflow-hidden w-[360px] border ">
      {/* image product */}
      ...
      <div>
        {edit && (
          <div className="flex items-center px-3 py-2 justify-between">
            ...
            <button className="p-2 bg-white transition-all duration-100 hover:bg-cinnabar-500 hover:text-white rounded-sm">
